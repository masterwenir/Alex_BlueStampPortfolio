...
I have completed two projects at Bluestamp, and my first project will be a close replica of a simple lie detector. It will include a GSR sensor that can check the electrical conductivity of your skin to see how much your sweating, as well as a pulseSensor that will check your hearbeat and monitor for sudden changes. These will help indicate whether a person is telling the truth; saying a lie will often cause nervousness. When the sensors detect unusual signals recieved, the buzzer will sound indicating that a lie has been told.
...
# Third Milestone (Remote Control Car)

<iframe width="800" height="520" src="https://www.youtube.com/embed/BErBQjy3VfI?si=5tMDhrMahjNK21FN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

For my third milestone, I have successfully created a remote controlled car. I built the basic car with just the smart robot car chassis kit, then I attached my motor driver and arduino board. I decided to add an ultrasonic sensor with a breadboard at the front of the car, and I also included a battery that allows for the motor driver to power the arduino, meaning the robot can drive without being connected to the computer. Before I was able to remote control it though, I had to be able to turn the motors on with code first. This was one of the struggles in this milestone, as I ran into multiple problems with the motors. For starters, saudering the motors were a huge issue as I didn't sauder them very well which resulted in the motors sometimes running and sometimes not. Then, my wires would also fall off from the connection with the motor driver, and the car would just stop mid-drive for no reason. I did fix these two problems eventually, and then I worked on simple code with the ultrasonic sensor that would make the car stop when it detects an obstacle in front of it. With the motors and ultrasonic sensor working, I went ahead to work on the remote control and added an IR receiver that would recieve signals from the remote control. I used the HEX codes received to know which button was being pressed on the remote, and combined this with IF statements to make the car drive forwards, backwards, turn, and stop. My remote control car was now complete, except for the fact that it didn't seem to be receiving the signals from the remote control very well. This was because the IR receiver was below the arduino board, so I placed on top of all the wires so that it would be able to receive signals the best. One thing that was new to me was how IR communication was used. IR is Infared light, which humans can't see, and this was pretty cool and fascinating to learn. My next and final milestone will to be make my ping pong ball launcher, and after making a working model I will attach it on top of the car. 

<img src="IMG_2607.jpg" alt="Remote Controlled Car" width="450"/>

# Second Milestone (Final Lie Detector)
...
<img src="IMG_2580.jpg" alt="LCD I2C Screen" width="500"/>
